...
import { GetReverseAlpha } from '@/app/services/DataService';
    ...
    <div className="min-h-screen bg-[#E6E9EE] font-sans dark:bg-[#E6E9EE]">
      <main className="text-black">
        ...
        <div className="mx-auto max-w-7xl text-center lg:py-16">
          <h1 className="py-8 mb-4 text-4xl font-bold tracking-tight leading-none md:text-5xl lg:text-6xl">Reverse It (Alphanumeric)</h1>

          <section className="flex justify-center">
            <div className="max-w-6xl p-6 card-color rounded-lg shadow-md ">
              <h5 className="lg:text-2xl xl:text-4xl font-normal tracking-tight text-left">This program takes a string and reverses the order of the string! Please enter a sequence of character below!</h5>
              <p className="my-6 lg:my-12 lg:text-2xl xl:text-4xl font-normal text-center">Enter a sequence of characters!</p>
              <div className="grid sm:grid-cols-2 place-items-center gap-4">
                <input value={inputValue} onKeyDown={HandleKeyDown} onChange={(e) => setInputValue(e.target.value)} type="text" className="bg-white ps-4 p-2 w-[16rem] rounded-lg" placeholder="Enter a word!" />
