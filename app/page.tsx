    ...
    <div className="min-h-screen bg-[#E6E9EE] font-sans dark:bg-[#E6E9EE]">
      <main className="text-black">
        ...
        <div className=" py-8 mx-auto max-w-7xl text-center lg:py-16">
          ...
          <p className="mb-8 text-lg font-normal lg:text-xl sm:px-16 lg:px-20 ">Here are the first 10 applications I learned to create in the CodeStack Academy! These 10 projects are all using API endpoints that I created and hosted via Azure! Please enjoy playing with all of my projects!</p>
